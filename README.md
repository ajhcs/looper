...
It is intentionally compact. The point is not to teach an agent how to think; it is to give a capable agent a reliable control loop.
...
4. Escalate only when the critic finds a concrete gap.

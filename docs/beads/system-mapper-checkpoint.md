...
- Files changed: `scripts/system-map.mjs`, `maps/examples/generated/analytics.html`, `maps/generated/looper-plugin.html`, `maps/looper-plugin.map.yaml`, `docs/beads/system-mapper-checkpoint.md`.
